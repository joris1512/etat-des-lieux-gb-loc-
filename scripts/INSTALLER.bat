@echo off
REM ================================================================
REM  INSTALLATION de l'Application Etat des lieux sur CE poste.
...
if not exist "%DST%\_internal\runtime" goto installation
...
:cle
if exist "%DST%\_internal\.env" goto raccourcis
if exist "%LOCALAPPDATA%\GB Etats des lieux - donnees\.env" goto raccourcis
echo.
echo --- Cle d'extraction des devis PDF ---
echo Sans cle, le logiciel fonctionne mais ne peut pas lire de nouveaux devis.
echo Collez la cle API puis appuyez sur Entree. Ou appuyez juste sur Entree pour passer.
set "CLEAPI="
set /p CLEAPI=Cle :
if not defined CLEAPI goto raccourcis
...
:raccourcis
echo Icone Bureau + menu Demarrer + demarrage automatique...
...
echo  L'application va s'ouvrir - icone Bureau : "Application
echo  Etat des lieux" (logo GB) pour les prochaines fois.
echo ============================================================
